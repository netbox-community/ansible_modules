                    ...
                    <div style="font-size: small">
                        <span style="color: purple">raw</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>Name of the device the interface template will be associated with (case-sensitive)</div>
                                                        </td>
            </tr>
                                <tr>
                                                    <td class="elbow-placeholder"></td>
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">boolean</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>This interface template is used only for out-of-band management</div>
                                                        </td>
            </tr>
                                <tr>
                                                    <td class="elbow-placeholder"></td>
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>Name of the interface template to be created</div>
                                                        </td>
            </tr>
                                <tr>
                                                    <td class="elbow-placeholder"></td>
