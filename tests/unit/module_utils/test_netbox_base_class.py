...
@pytest.mark.parametrize(
    ...
    [
        ...
        ({"circuit_termination": "Test Circuit"}, {'circuit_termination': 'Test Circuit'}),
        ({"circuit_type": "Test Circuit Type"}, {'circuit_type': 'test-circuit-type'}),
        ({"cluster": "Test Cluster"}, {'cluster': 'Test Cluster'}),
        ({"cluster_group": "Test Cluster_group"}, {'cluster_group': 'test-cluster_group'}),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "vlans",
            {"status": "Active", "status": "Reserved", "status": "Deprecated", "status": 2},
